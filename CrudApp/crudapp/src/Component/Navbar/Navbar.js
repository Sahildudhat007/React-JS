...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="relative w-full py-3 shadow-lg">
                <div className="mx-auto flex max-w-7xl items-center sticky justify-between px-4 py-2 sm:px-6 lg:px-8">
                    <div className="inline-flex items-center space-x-2">
                        ...
                        <span className="font-bold">Dudhat</span>
                    </div>
